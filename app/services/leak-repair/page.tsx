...
export default function LeakRepairPage() {
  return (
    <>
      ...
      {/* Leak repair by neighborhood — links DOWN to location pages */}
        ...
        <div className="container-page max-w-4xl">
          ...
          <div className="mt-6 space-y-7">
            {locationsByGroup().map(({ group, items }) => {
              const local = items.filter((l) => leakRepairCopy[l.slug]);
