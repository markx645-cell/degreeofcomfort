...
| 9 | **FAQ** (4–6 Q&A) | S | Long-tail questions | ≥1–2 localized; mark up with FAQPage schema |
| 10 | **Closing CTA** | R | Primary | Call now + phone |
| 11 | **Internal-links module** | S | — | Adjacent neighborhoods + related services + hub |
...
### Cross-cutting rules
- **Uniqueness:** ≥50% of visible body text unique to the neighborhood. Sections 2 and 4 must be written fresh per page.
...
- [ ] Sections 2 and 4 written uniquely for this neighborhood (≥3 local specifics)
...
*Repeat Part 2's structure for every [service × neighborhood] page, swapping the variables and writing sections 2 and 4 fresh each time.*
